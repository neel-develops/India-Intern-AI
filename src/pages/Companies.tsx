          ...
          <Card key={company.id} className="flex flex-col">
            <CardHeader className="flex flex-row items-start gap-4">
              ...
              <div>
                ...
                <CardDescription>
                    <Link to={company.website} target="_blank" className="inline-flex items-center gap-1 hover:underline">
            ...
            <div className="p-6 pt-0">
                <Button asChild className="w-full">
                    <Link to={`/companies/${company.id}`}>View Profile & Internships</Link>
                </Button>
            </div>
          </Card>
        ))}
